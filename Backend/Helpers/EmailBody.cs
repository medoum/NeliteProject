...
namespace Backend.Helpers
{
	public static class EmailBody
	{
		...
		<div>
			...
			<hr>
			<p>You're receiving this e-mail because you requested a password reset for your Exakis nelite account.</p>
			...
			color:white; border-radius:4px;display:block;margin:0 auto;width:50px;text-align:center;text-decoration:none"">Reset Password</a><br>
